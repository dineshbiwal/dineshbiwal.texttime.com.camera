...
import com.example.imagecroping.MoveGestureDetector;
import com.example.imagecroping.RotateGestureDetector;
...
public class CropActivity extends Activity implements OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().hasExtra("status")){
        	Log.d("Url", getIntent().getExtras().getString("status"));
	        	setSelectedImage(getIntent().getExtras().getString("status"));
        }
    ...
    private static class CropHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            CropActivity c = new CropActivity();
