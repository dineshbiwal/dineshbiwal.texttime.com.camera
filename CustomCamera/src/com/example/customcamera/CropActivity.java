...
import com.example.customcamera.MoveGestureDetector;
import com.example.customcamera.RotateGestureDetector;
...
public class CropActivity extends Activity implements OnTouchListener {
    ...
    public static Bitmap croppedImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedVersion = getIntent().getExtras().getInt(CameraDemoActivity.CROP_VERSION_SELECTED_KEY, -1);
        ...
        if(getIntent().hasExtra("status")){
        	Log.d("Url", getIntent().getExtras().getString("status"));
        	photoImg = BitmapFactory.decodeFile(getIntent().getExtras().getString("status"));
	     }
    ...
    public void onCropImageButton(View v) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (mScreenWidth == 320 && mScreenHeight == 480) {
                    if (mSelectedVersion == CameraDemoActivity.VERSION_1) {
       ...
       //mImg.setImageBitmap(croppedImg);
       //mTemplateImg.setImageBitmap(croppedImg);
       //Log.e("URL",croppedImg.toString());
    }
    ...
    void gotoShowImage()
    {
    	...
    	intent.putExtra("imagePath", getIntent().getExtras().getString("status"));
    	finish();
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == MEDIA_GALLERY) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                	templateImg = BitmapFactory.decodeResource(getResources(), R.drawable.hexa_face);
                	break;
                }
    ...
    private static class CropHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            final CropActivity ca = mThisCA.get();
